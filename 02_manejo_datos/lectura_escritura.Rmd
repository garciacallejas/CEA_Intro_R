...
# podemos especificar si queremos una columna que guarde los nombres de las filas de nuestro dataframe

# estas dos órdenes son equivalentes
# write.table(x = a2,file = "../data/archivo_nuevo.csv",sep = ";",row.names = FALSE)
# write.csv2(x = a2,file = "../data/archivo_nuevo.csv",row.names = FALSE)

# y para guardar un archivo csv separado por comas, usamos
# write.csv(x = a2, file = "../data/archivo_nuevo_comas.csv", row.names = FALSE)
